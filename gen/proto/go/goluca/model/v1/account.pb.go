...
const file_goluca_model_v1_account_proto_rawDesc = "" +
	"\n" +
	"\x1dgoluca/model/v1/account.proto\x12\x0fgoluca.model.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf8\x01\n" +
	"\aAccount\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12 \n" +
	"\tparent_id\x18\x02 \x01(\tH\x00R\bparentId\x88\x01\x01\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x120\n" +
	"\x04type\x18\x04 \x01(\x0e2\x1c.goluca.model.v1.AccountTypeR\x04type\x12,\n" +
	"\x05basis\x18\x05 \x01(\x0e2\x16.goluca.model.v1.BasisR\x05basis\x129\n" +
	"\n" +
	...
	"\fBASIS_CREDIT\x10\x02B\xc5\x01\n" +
	"\x13com.goluca.model.v1B\fAccountProtoP\x01ZBgithub.com/hampgoodwin/GoLuca/gen/proto/go/goluca/model/v1;modelv1\xa2\x02\x03GMX\xaa\x02\x0fGoluca.Model.V1\xca\x02\x0fGoluca\\Model\\V1\xe2\x02\x1bGoluca\\Model\\V1\\GPBMetadata\xea\x02\x11Goluca::Model::V1b\x06proto3"

var (
	file_goluca_model_v1_account_proto_rawDescOnce sync.Once
	file_goluca_model_v1_account_proto_rawDescData []byte
)

func file_goluca_model_v1_account_proto_rawDescGZIP() []byte {
	file_goluca_model_v1_account_proto_rawDescOnce.Do(func() {
		file_goluca_model_v1_account_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_goluca_model_v1_account_proto_rawDesc), len(file_goluca_model_v1_account_proto_rawDesc)))
	})
...
var file_goluca_model_v1_account_proto_goTypes = []any{
...
func file_goluca_model_v1_account_proto_init() {
	...
	file_goluca_model_v1_account_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_goluca_model_v1_account_proto_rawDesc), len(file_goluca_model_v1_account_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
